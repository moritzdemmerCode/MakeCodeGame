...
def createEnemies():
    ...
    for value5 in tiles.get_tiles_by_type(img("""
        tile4
    """)):
    ...
    for value6 in tiles.get_tiles_by_type(img("""
        tile7
    """)):
...
def initializeLevel(level: number):
    ...
    playerStartLocation = tiles.get_tiles_by_type(img("""
        tile6
    """))[0]
    tiles.place_on_tile(hero, playerStartLocation)
    tiles.set_tile_at(playerStartLocation, img("""
        tile0
    """))
    createEnemies()
    spawnGoals()
...
def spawnGoals():
    global coin
    for value7 in tiles.get_tiles_by_type(img("""
        tile5
    """)):
