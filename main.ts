...
function animateRun () {
    ...
    mainRunLeft.addAnimationFrame(assets.image`SuperMario`)
    mainRunLeft.addAnimationFrame(assets.image`SuperMario`)
    mainRunLeft.addAnimationFrame(assets.image`SuperMario`)
    mainRunLeft.addAnimationFrame(assets.image`SuperMario`)
    mainRunRight = animation.createAnimation(ActionKind.Walking, 100)
    animation.attachAnimation(hero, mainRunRight)
    mainRunRight.addAnimationFrame(assets.image`SuperMario`)
    mainRunRight.addAnimationFrame(assets.image`SuperMario`)
    mainRunRight.addAnimationFrame(assets.image`SuperMario`)
    mainRunRight.addAnimationFrame(assets.image`SuperMario`)
}
...
function animateCrouch () {
    ...
    mainCrouchLeft.addAnimationFrame(assets.image`SuperMario`)
    mainCrouchRight = animation.createAnimation(ActionKind.Walking, 100)
    animation.attachAnimation(hero, mainCrouchRight)
    mainCrouchRight.addAnimationFrame(assets.image`SuperMario`)
}
...
function initializeLevel (level: number) {
    ...
    tiles.setTileAt(playerStartLocation, assets.tile`Mario`)
    createEnemies()
    spawnGoals()
}
...
hero = sprites.create(assets.image`SuperMario`, SpriteKind.Player)
